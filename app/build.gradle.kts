...
android {
    ...
    signingConfigs {
        create("release") {
            storeFile = file("/Users/dutchman/AndroidStudioProjects/android_apk_keystore/btb")
            storePassword = "explorebangladesh"
            keyAlias = "explorebangladesh"
            keyPassword = "explorebangladesh"
        }
    }
    configCommon()

    defaultConfig {
        applicationId = "com.btb.explorebangladesh"
        versionCode = 5
        versionName = "1.0.5"
...
//    useExoplayer()
    ...
    implementation(DepUtils.facebookLogin)
